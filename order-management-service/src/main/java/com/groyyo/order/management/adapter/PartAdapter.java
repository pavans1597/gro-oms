...
public class PartAdapter {
    ...
    public BulkPartRequestDto buildPartFromBulkOrderRequest(BulkOrderExcelRequestDto bulkOrderExcelData, ArrayList<BulkColorRequestDto> colors) {
        return BulkPartRequestDto.builder()

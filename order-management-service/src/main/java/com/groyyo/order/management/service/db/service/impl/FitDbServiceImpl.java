...
import com.groyyo.order.management.service.db.service.FitDbService;
import com.groyyo.order.management.service.entity.Fit;
import com.groyyo.order.management.service.repository.FitRepository;
...
public class FitDbServiceImpl extends AbstractJpaServiceImpl<Fit, Long, FitRepository> implements FitDbService {
    ...
    public List<Fit> getAllFitsForStatus(boolean status) {
        return fitRepository.findByStatus(status);
    }

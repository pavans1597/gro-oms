...
@Entity(name = "part")
@Table(name = "part", uniqueConstraints = { @UniqueConstraint(name = "UK_part_name_factory_id", columnNames = { "name", "factory_id" }) })
public class Part extends AbstractJpaEntity {

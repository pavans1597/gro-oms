...
@Entity(name = "buyer")
@Table(name = "buyer", uniqueConstraints = { @UniqueConstraint(name = "UK_buyer_name_factory_id", columnNames = { "name", "factoryId" }) })
public class Buyer extends AbstractJpaEntity {

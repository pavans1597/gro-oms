...
public class PurchaseOrderPublisher {
	...
	public void publishPushNotificationEvent(PushNotificationDTO pushNotificationDTO, Map<String,Object> kafkaMetadata) {
		...
		log.info("Publish Push Notification Event: {} ", kafkaDTO);
	}
}

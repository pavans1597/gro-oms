...
import com.groyyo.order.adapter.SeasonAdapter;
import com.groyyo.order.constants.KafkaConstants;
import com.groyyo.order.db.service.SeasonDbService;
import com.groyyo.order.entity.Season;
import com.groyyo.order.service.SeasonService;
...
public class SeasonServiceImpl implements SeasonService {
    ...
    public SeasonResponseDto addSeason(SeasonRequestDto seasonRequestDto) {
        ...
        publishSeason(seasonResponseDto, KafkaConstants.KAFKA_SEASON_TYPE, KafkaConstants.KAFKA_SEASON_SUBTYPE_CREATE, kafkaMasterDataUpdatesTopic);

...
import com.groyyo.order.adapter.BuyerAdapter;
import com.groyyo.order.db.service.BuyerDbService;
import com.groyyo.order.entity.Buyer;
import com.groyyo.order.service.BuyerService;
...
public class BuyerServiceImpl implements BuyerService {
    ...
    public List<BuyerResponseDto> getAllBuyers(Boolean status) {
        ...
        List<Buyer> buyerEntities = Objects.isNull(status) ? buyerDbService.getAllBuyers()
                : buyerDbService.getAllBuyersForStatus(status);
    ...
    public BuyerResponseDto addBuyer(BuyerRequestDto buyerRequestDto) {
        ...
        Buyer buyer = BuyerAdapter.buildBuyerFromRequest(buyerRequestDto);
...
//        publishBuyer(buyerResponseDto, KafkaConstants.KAFKA_SIZE_TYPE, KafkaConstants.KAFKA_SIZE_SUBTYPE_UPDATE, kafkaMasterDataUpdatesTopic);
    ...
    public void consumeBuyer(BuyerResponseDto buyerResponseDto) {
        Buyer buyer = BuyerAdapter.buildBuyerFromResponse(buyerResponseDto);
